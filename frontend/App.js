                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-20">
                        <Link to="/" className="flex items-center space-x-2">
                            ...
                            <span className="font-bold text-lg text-[#003B71]">SLC</span>
                        </Link>
...
const AboutPage = () => {
    // Fetch and display content for SLC and Dargah
    // Include alternating image/text sections and embedded video
    return <PageWrapper> <div className="p-8"><h1 className="text-4xl">About SLC & Dargah Sharif</h1></div> </PageWrapper>
};
